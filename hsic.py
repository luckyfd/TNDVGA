'''
***Closely based on code for Rebias by Hyojin Bahng***
https://github.com/clovaai/rebias
See also the paper:
Bahng, H., Chun, S., Yun, S., Choo, J., & Oh, S. J. (2020). Learning de-biased representations with biased representations. https://proceedings.mlr.press/v119/bahng20a/bahng20a.pdf
'''
